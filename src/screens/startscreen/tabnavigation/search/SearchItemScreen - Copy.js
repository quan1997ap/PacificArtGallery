      ...
      <View style={{ flex: 1 }}>
        ...
        <View style={{ flex: 1 }}>
          ...
          <ScrollView style={[styles.scrollView, { flex: 1 }]}>
            <View style={{ height: this.state.visibleLoading ? 50 : 0 , marginTop: 10 }}>
              <LoadingComponent Visible={this.state.visibleLoading} />
            </View>
            <Text
              style={{
                height: this.state.searchResultNull ? 40 : 0,
                paddingLeft: "5%"
              }}
            >
              {I18n.t("NORESULT")}
            ...
            <Text
              style={{
                height: this.state.searchErr ? 40 : 0,
                paddingLeft: "5%"
              }}
            >
              {I18n.t("SEARCHERR")}
...
const styles = StyleSheet.create({
  ...
  filterButton: {
    ...
    position: "absolute",
    top: 0,
    left: widthPercentageToDP("83%") - 80,
